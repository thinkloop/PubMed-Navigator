...
import com.pubmednavigator.search.events.SubmitEvent;
...
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
	...
	private var _searchBoxText:String;
	private var _cleanSearchBoxText:String;
	private var _keywords:Array;
	[Bindable]
	public function set searchBoxText(value:String):void {
		if(_searchBoxText != value) {
			_searchBoxText = value;
			_cleanSearchBoxText = StringUtil.cleanExtraWhiteSpace(value);
